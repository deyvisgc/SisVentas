...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="" class="logo">
            ...
            <span class="logo-lg"><b>SIS</b>Video</span>
        </a>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{asset('Imagenes/Usuario/'.Auth::user()->imagen)}}"  class="user-image" alt="User Image">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                @if(Auth::user()->idRol==2)
                    <li class="active treeview">
                        <a href="#">
                            <i class="fa fa-dashboard"></i> <span>Panel del Administrador</span>
                            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                        </a>
                        <ul class="treeview-menu">
                            <li class="active"><a href="{{url('Usuario')}}"><i class="fa fa-circle-o"></i>Listar Usuario</a></li>
                            <li><a href="{{url('User/redirec')}}"><i class="fa fa-circle-o"></i> Registrar Usuario</a></li>
                        </ul>
                    </li>
                    <li class="active treeview">
                        <a href="#">
                            <i class="fa fa-dashboard"></i> <span>Panel del Provedores</span>
                            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                        </a>
                        <ul class="treeview-menu">
                            <li class="active"><a href="{{url('Provedor')}}"><i class="fa fa-circle-o"></i>Listar Provedor</a></li>
