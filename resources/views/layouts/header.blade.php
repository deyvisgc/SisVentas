...
<div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row default-layout-navbar">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo" href="{{asset('index-2.html')}}"><img src="{{asset('images/logo.svg')}}" alt="logo"/></a>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="page-layouts">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item d-none d-lg-block"> <a class="nav-link" href="{{url('User/redirec')}}">Registro Usuario</a></li>
                            <li class="nav-item"> <a class="nav-link" href="{{url('auth')}}">RTL</a></li>
